...
abstract final class HubTheme {
  ...
  // Dark semantic roles — explicit elevation, not mechanical invert of HubColors.
  static const Color _canvasDark = Color(0xFF12171C);
  static const Color _surfaceDark = Color(0xFF1C2329);
  static const Color _inkDark = Color(0xFFE8EDF2);
  static const Color _inkMutedDark = Color(0xFF9AA5B0);
  static const Color _borderDark = Color(0xFF2E3842);
  ...
  static ThemeData dark() {
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: const TextStyle(color: _inkMutedDark),
        errorStyle: const TextStyle(color: HubColors.error, fontSize: 13),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          minimumSize: const Size(minTouchTarget, minTouchTarget),
          foregroundColor: HubColors.onPrimaryMuted,
        ),
      ),
      focusColor: HubColors.focusRing.withValues(alpha: 0.24),
      hoverColor: HubColors.seed.withValues(alpha: 0.12),
      checkboxTheme: CheckboxThemeData(
        fillColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return HubColors.seed;
        ...
        side: const BorderSide(color: _inkMutedDark, width: 1.5),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(4),
        ),
      ),
