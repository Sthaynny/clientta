...
**Scripts ficam só na skill global** — este repo não tem `tool/` de composição.
...
Instalar/atualizar skill: `bash my_utils/.agents/skills/publicidade/scripts/install-global.sh`
